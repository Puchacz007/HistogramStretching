...
blueMax:					
	ble $t7,$t3,increaseBlue ## check if loaded blue value is max
...
greenMax:					
	ble $t7,$t4,increaseGreen ## check if loaded green value is max
...
redMax:	
	ble $t7,$t5,increaseRed ## check if loaded red value is max
...
alpha:
	...
	move $t6,$s2 ## load pixel array adress
	move $t9,$s5 ## load size of data
	li $s3,255 ## bigest color value for one color using 8 bits
